...
public class NotePad extends JFrame implements ActionListener, ItemListener {
	...
	public int askForSave() {
		...
		if (text.getText().equals(strtext) == false) {
			...
			int i = JOptionPane.showConfirmDialog(this, " 文件 " + fn
					+ " 的文字已经改变。 " + " /n要保存文件吗？ ", " 记事本 ",
	...
	public void replaceAll(String fromStr, String toStr, int cur, int end) {
		if (cur > end) {
			...
			if (i >= 0) {
				...
				JOptionPane
						.showMessageDialog(this, " 替换完毕！ ", " 记事本 ",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (com.equals(" about ")) {
			JOptionPane.showMessageDialog(this,
					" 我的记事本  V1.0/n作者：ZhiJian Zhang /n2005/5/25 Copyright ",
					" 关于我的记事本 ", JOptionPane.OK_OPTION
							+ JOptionPane.INFORMATION_MESSAGE);
		}
		// 观感选择
		...
		if (e.getActionCommand().equals(" Windows ")) {
			// String
			// windows_str="com.sun.java.swing.plaf.windows.WindowsClassicLookAndFeel"
